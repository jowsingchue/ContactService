...
public class JettyMain {
	...
	public static void main(String[] args) throws Exception {
		...
		// If you use "/" it means the server root (map all requests to context).
		...
		// The PROVIDER_PACKAGES initialization parameter tells Jersey to auto-configure 
...
//		context.addFilter(RequestLogFilter.class, "/", EnumSet.of(DispatcherType.REQUEST) );
	...
	public static Boolean startServer(int port) throws Exception {
